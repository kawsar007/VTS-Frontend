...
export default function ModalCloseButton({ closeModal }) {
	return (
		<button
			...
			className='absolute right-2 top-2 flex h-10 w-10 items-center justify-center rounded-full bg-gray duration-150 ease-in hover:text-black dark:bg-gray-7 dark:hover:text-white sm:right-4 sm:top-4'
		>
			<svg
